...
--
-- Gép: localhost
-- Létrehozás ideje: 2026. Feb 07. 14:09
...
--
-- Tábla szerkezet ehhez a táblához `lookingfor_rents`
--

CREATE TABLE `lookingfor_rents` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `rents` (
  ...
  `default_image` char(36) DEFAULT NULL,
...
--
-- A tábla indexei `lookingfor_rents`
--
ALTER TABLE `lookingfor_rents`
  ADD PRIMARY KEY (`id`);
