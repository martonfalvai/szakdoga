...
const MOCK_DATA: ApartmentData = {
  ...
  description:
    "Elegáns, teljesen felújított 2 szobás lakás Budapest szívében. Közel a metróhoz és a főbb bevásárlóközpontokhoz. Berendezett, azonnal beköltözhető.",
  price: 180000,
  currency: "HUF",
  city: "Budapest",
...
const MOCK_REVIEWS = [
  {
    id: 1,
    user_name: "Kovács Anna",
    rating: 5,
    comment:
      "Fantasztikus lakás, minden tiszta és modern. A tulajdonos nagyon segítőkész volt!",
  },
  {
    id: 2,
    ...
    rating: 4,
    comment:
      "Remek elhelyezkedés, kényelmes bútorok. Kicsit zajos az utca éjszaka.",
  },
  {
    id: 3,
    user_name: "Szabó Mária",
    rating: 5,
    comment: "Tökéletes volt mindenben, legközelebb is ide jövünk!",
  },
];
...
const Apartment = () => {
  ...
  const avgRating = (
    MOCK_REVIEWS.reduce((a, r) => a + r.rating, 0) / MOCK_REVIEWS.length
  ).toFixed(1);
